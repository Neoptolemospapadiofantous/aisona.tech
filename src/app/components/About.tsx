      ...
      <section className="py-12 sm:py-20 px-4 relative z-10 pt-20 sm:pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-lg sm:text-xl text-black leading-relaxed mb-8 sm:mb-12 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12">
            {missionPoints.map((point, index) => {
              ...
              return (
                <div 
                  key={index}
                  className={`bg-white border border-gray-200 rounded-xl p-4 sm:p-6 text-center transition-all duration-500 transform cursor-pointer group hover:shadow-xl hover:border-blue-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                  style={{ animationDelay: `${0.5 + index * 0.1}s` }}
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-blue-100 border border-blue-200 flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-all duration-500 group-hover:shadow-lg group-hover:scale-110">
                    <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" />
                  </div>
                  
                  <h3 className="text-lg sm:text-xl font-bold text-blue-600 mb-2 sm:mb-3 transition-all duration-300 group-hover:scale-105">
                    {point.title}
                  </h3>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            {implementationSteps.map((item, index) => (
              ...
              >
                ...
                <div className={`bg-blue-50 rounded-lg p-3 sm:p-4 transition-all duration-500 ${
                    hoveredStep === index 
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <button 
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-all duration-500 shadow-xl hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 flex items-center justify-center gap-2 min-h-[48px]"
                  >
                    <Users className="w-4 h-4 sm:w-5 sm:h-5" />
                    <span className="text-sm sm:text-base">Schedule Demo</span>
                  </button>
                  <Link 
                    href="/services"
                    className="bg-transparent border-2 border-blue-600 text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold text-sm sm:text-lg transition-all duration-300 transform hover:bg-blue-600 hover:text-white hover:scale-105 no-underline min-h-[48px] flex items-center justify-center"
                  >
                    View Our Services
                  </Link>
                </div>
