  ...
  return (
    <div className="min-h-screen bg-white pt-16 sm:pt-20">
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        {/* What Are Cookies */}
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 sm:p-6 mb-8 sm:mb-12">
          <div className="flex flex-col sm:flex-row items-start gap-3">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 sm:mb-6">Cookies We Use</h2>
              ...
              <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row items-start justify-between mb-3 sm:mb-4 gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-black">{category.category}</h3>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 sm:mb-6">Third-Party Service</h2>
                ...
                <div className="grid grid-cols-1 gap-3 sm:gap-4">
                  <div className="flex flex-col sm:flex-row items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-semibold text-black text-base sm:text-lg">{service.service}</h3>
                    </div>
                    <a 
                      href={service.privacyPolicy} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center gap-1 text-sm text-blue-600 hover:text-blue-700 underline min-h-[44px] px-2 py-1 rounded hover:bg-blue-50 transition-colors"
                    >
        ...
        {/* Cookie Management */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-black mb-4 sm:mb-6">Managing Cookies</h2>
        ...
        <div className="bg-blue-50 rounded-lg p-6 sm:p-8 text-center border border-blue-200">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <Cookie className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600" />
            <h3 className="text-lg sm:text-xl font-semibold text-black">Questions About Cookies?</h3>
          </div>
          <p className="text-gray-600 mb-4 sm:mb-6 text-sm sm:text-base">
