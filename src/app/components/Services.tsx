...
const Services = () => {
  ...
  return (
    <div id="services-section" className="min-h-screen bg-white relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="py-12 sm:py-20 px-4 relative z-10 pt-20 sm:pt-32">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-base sm:text-lg text-black max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-8">
          ...
          {/* Trust Indicators */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 max-w-3xl mx-auto mb-8 sm:mb-12">
            {trustIndicators.map((indicator, index) => (
              <div key={index} className="text-center bg-white rounded-xl p-3 sm:p-4 shadow-sm border border-gray-100">
                <div className="text-lg sm:text-2xl font-bold text-blue-600 mb-1">{indicator.number}</div>
                <div className="text-xs sm:text-sm text-black">{indicator.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className={`text-center mb-12 sm:mb-16 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`group p-6 sm:p-8 rounded-2xl border transition-all duration-700 transform cursor-pointer relative overflow-hidden ${
                    activeService === index
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4 sm:mb-6 relative z-10">
                    <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-2xl transition-all duration-500 ${
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-black leading-relaxed text-sm sm:text-base transition-colors duration-300 group-hover:text-gray-700">
                        {service.description}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Stats */}
                  <div className={`bg-blue-50 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 transition-all duration-500 ${
                      activeService === index 
                        ? 'shadow-lg scale-105 bg-blue-100' 
                        : 'group-hover:shadow-lg group-hover:scale-105'
                    }`}>
                    <div className="text-center">
                      <div className={`text-xl sm:text-2xl font-bold text-blue-600 mb-1 transition-all duration-300 ${
                          activeService === index ? 'text-2xl sm:text-3xl' : 'group-hover:text-2xl sm:group-hover:text-3xl'
                        }`}>
                        {service.stats.primary}
                      </div>
                      <div className="text-xs sm:text-sm text-black font-medium transition-colors duration-300 group-hover:text-gray-700">
                  ...
                  <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    {service.features.map((feature, featureIndex) => (
                      <li 
                        key={featureIndex} 
                        className="flex items-center gap-2 sm:gap-3 transition-all duration-300 hover:translate-x-2 hover:bg-gray-50/80 hover:rounded-lg hover:p-2 hover:-m-2"
                        style={{ transitionDelay: `${featureIndex * 50}ms` }}
                      >
                        <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 flex-shrink-0" />
                        <span className="text-black font-medium text-xs sm:text-sm transition-colors duration-300 hover:text-gray-900">
                          {feature}
                        </span>
                      </li>
                    ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
            {implementationSteps.map((step, index) => (
              ...
              >
                <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 mb-4 sm:mb-6 relative z-10">
                  <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl flex items-center justify-center text-lg sm:text-xl font-bold shadow-2xl transition-all duration-500 ${
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-black leading-relaxed text-sm sm:text-base transition-colors duration-300 group-hover:text-gray-700 mb-3 sm:mb-4">
                      {step.description}
                    </p>
                  </div>
                </div>
                ...
                {/* Timeline */}
                <div className={`bg-blue-50 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4 transition-all duration-500 ${
                    hoveredStep === index 
                      ? 'shadow-lg scale-105 bg-blue-100' 
                      : 'group-hover:shadow-lg group-hover:scale-105'
                  }`}>
                  <div className="text-center">
                    <div className={`text-xl sm:text-2xl font-bold text-blue-600 mb-1 transition-all duration-300 ${
                        hoveredStep === index ? 'text-2xl sm:text-3xl' : 'group-hover:text-2xl sm:group-hover:text-3xl'
                      }`}>
                      {step.timeline}
                    </div>
                    <div className="text-xs sm:text-sm text-black font-medium transition-colors duration-300 group-hover:text-gray-700">
                ...
                <div className="space-y-1 sm:space-y-2">
                  <h4 className="font-semibold text-gray-900 text-xs sm:text-sm">Key Deliverables:</h4>
        ...
        <div className="max-w-6xl mx-auto">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} 
            ...
            <div className="text-center mb-8 sm:mb-12">
              <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-blue-600 transition-transform duration-300 inline-block hover:scale-105">
                Measurable Business Impact
              </h3>
              <p className="text-lg sm:text-xl text-black max-w-2xl mx-auto transition-colors duration-300 hover:text-gray-700">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`bg-white border border-gray-200 rounded-xl p-4 sm:p-6 text-center transition-all duration-500 transform cursor-pointer group ${
                  ...
                  >
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-blue-100 border border-blue-200 flex items-center justify-center mx-auto mb-3 sm:mb-4 transition-all duration-500 ${
                    ...
                    <div className={`text-2xl sm:text-3xl font-bold text-blue-600 mb-1 transition-all duration-300 ${
                        hoveredBenefit === index ? 'text-3xl sm:text-4xl' : 'group-hover:text-3xl sm:group-hover:text-4xl'
                      }`}>
                      {benefit.stat}
                    </div>
                    
                    <div className="text-xs text-gray-500 mb-2 sm:mb-3 transition-colors duration-300 group-hover:text-gray-600">
                      {benefit.detail}
                    </div>
                    
                    <h4 className={`font-semibold text-black mb-2 text-sm sm:text-base transition-all duration-300 ${
                        hoveredBenefit === index ? 'text-blue-700 scale-105' : 'group-hover:text-blue-700 group-hover:scale-105'
                      }`}>
                      {benefit.title}
                    </h4>
                    
                    <p className="text-black text-xs sm:text-sm transition-colors duration-300 group-hover:text-gray-700">
                      {benefit.description}
                    </p>
                  </div>
                );
      ...
      <section className="py-12 sm:py-20 px-4 bg-gradient-to-r from-blue-600 to-blue-800 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-white border border-gray-200 rounded-2xl shadow-2xl p-6 sm:p-8 transition-all duration-500 hover:shadow-3xl hover:scale-105 group relative overflow-hidden">
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-black transition-all duration-300 group-hover:text-blue-700">
                  Ready to Transform Your Business?
                </h2>
                <p className="text-black mb-6 sm:mb-8 max-w-2xl mx-auto text-base sm:text-lg transition-colors duration-300 group-hover:text-gray-700">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                  <button 
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-all duration-500 shadow-xl hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 flex items-center justify-center gap-2 group/btn relative overflow-hidden min-h-[48px] sm:min-h-[56px]"
                  >
                    <Bot className="w-4 h-4 sm:w-5 sm:h-5 relative z-10" />
                    <span className="relative z-10 text-sm sm:text-base">Schedule Demo</span>
                  </button>
                </div>
              </div>
            </div>
